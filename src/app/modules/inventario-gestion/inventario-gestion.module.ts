...
import { InsertarInventarioComponent } from './insertar-inventario/insertar-inventario.component';


const VentanillaRoutes: Route[] = [
    {
        path     : '',
        component: InventarioGestionComponent,
        children : [
            {
...
export class InventarioGestionModule
{
}